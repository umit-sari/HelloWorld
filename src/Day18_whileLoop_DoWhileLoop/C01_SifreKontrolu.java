...
public class C01_SifreKontrolu {
    public static void main(String[] args) {
         ...
         */
        boolean sonuc = false;
        Scanner scanner; // her false da devamlı obje olusturmasın diye önce tanımlama yaptık
        // sonra asagıda deger atadık.daha profesyonel yazım için böyle kullanmak daha iyi
        String sifre;
        while (!sonuc){ // sonuc == false  isleminin sonucu - daha profesyonel yazım için böyle kullanmak daha iyi
