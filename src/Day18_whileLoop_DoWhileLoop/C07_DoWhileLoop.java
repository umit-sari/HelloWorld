...
public class C07_DoWhileLoop {
         ...
         */
                ...
                System.out.println("do while loop ile aradaki sayilarin toplami : " + toplam); // 30 sart kontrolu yapmadan
                // direk işleme gecti ve 30 yazdırdı. sonra bas <= bit sartını tasımadıgı sartını kontrol etti ve calışmayı
                // durdurdu.
