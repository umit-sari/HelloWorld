...
public class C05_get_set {
    public static void main(String[] args) {
        ...
        isimler.set(2,"Ayse");
        System.out.println(isimler); // [Cemil, Omer, Ayse, Mertkan] - burhan'ı güncelleyerek ayşe yaptı.
        System.out.println(isimler.get(1)); // Omer-- 1.indeksteki elementi getir diyoruz
