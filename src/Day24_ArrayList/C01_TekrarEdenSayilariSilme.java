...
public class C01_TekrarEdenSayilariSilme {
    public static void main(String[] args) {
         ...
         */
        List<Integer> tekrarsizList = new ArrayList<>(); // int degil INTEGER kullanıyoruz.data turu PRIMITIVE data turleri OLAMAZ
        ...
        for (int i = 0; i < arr.length ; i++) {
            if (!tekrarsizList.contains(arr[i])){ // contains içeriyor mu sorusunun cevabını veriyor
