...
public class C04_Remove {
    public static void main(String[] args) {
        ...
        System.out.println(isimler); // [Bulent, Tugba, Burhan, Kaan] // ilk buldugu kaan 'ı siliyor.
        ...
        // silmek istediğimiz element var ise önce onu tanımlıyoruz (Integer silinecekElement = 1;)
        // sonra remove ile siliyoruz.
