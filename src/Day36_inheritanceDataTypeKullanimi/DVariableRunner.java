...
public class DVariableRunner {
    public static void main(String[] args) {
        CAvciKuslar avciKusKartal = new CAvciKuslar(); // data turu CAvciKuslar ve constructor CAvciKuslar()
        ...
        BKuslar kusKartal = new CAvciKuslar(); // data turu BKuslar ve constructor CAvciKuslar()
        ...
        AHayvan hayvanKartal = new CAvciKuslar(); // data turu AHayvan ve constructor CAvciKuslar()
    ...
    /*
        ...
        Eger constructor ve data turu farkli ise orn. AHayvan hayvanKartal = new CAvciKuslar();
        objenin ozelliklerini aramaya DATA TURU olan  (AHayvan class'ından) class'dan baslanir
        EGER ozellikler variable olarak olusturuldu ise
        objenin ozelliklerini DATA TURU ( örnek :AHayvan data turu) belirler
     */
}