...
public class C03_substring {
    public static void main(String[] args) {
        ...
        /*
            ...
            2- baslangic ve bitis indexlerini verirseniz baslangic index'inden (dahil) baslar
               bitis index'ine kadar(haric) aradaki karakterleri yazdirir
         */
        System.out.println(str.substring(3)); // a Candir . J=0,a=1,v=2,a=3 0'dan başlar index sayıma
        ...
        System.out.println(str1.concat(str2).concat(str3)); // Java Candir// concat stringleri birlestirme(+)
    }
}
