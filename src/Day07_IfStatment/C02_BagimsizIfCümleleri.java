...
public class C02_BagimsizIfCümleleri {
    public static void main(String[] args) {
        ...
        if (a % 2 == 0)
           ...
           // ilk ; e kadar olan kisim if body'sidir.a%2==0 olmadıgından if body si sonuc döndürmedi.
           // bir sonraki alt satıra gecti.

           // sonraki satirlarin if ile ilgisi yoktur.metin olarak sonuc dönüyor.
