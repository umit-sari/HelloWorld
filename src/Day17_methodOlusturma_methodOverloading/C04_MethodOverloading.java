...
public class C04_MethodOverloading {
    ...
    public static void toplama(int sayi1 , int sayi2){ // toplama int int.....(signature)
        System.out.println("iki int'in toplami : " + (sayi1+sayi2));
    }
    public static void toplama(int a , double b){ // toplama int double....(signature)
        System.out.println("int ile double'in toplami : " + (a+b));
    }
    public static void toplama(double b , int a){ // toplama double int ...(signature)
