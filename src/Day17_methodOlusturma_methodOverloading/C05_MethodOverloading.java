...
public class C05_MethodOverloading {
    public static void main(String[] args) {
        /* method overloading ismi aynı,signature'ları farklı methodlara denir.
            ...
            4- minumum casting
         */
        toplama('s'); // tek int girilirse 2 kati yazilir : 230 - char matematiksel işleme ASCİ degeri ile girer
        toplama(3,4); // iki int'in toplami : 7- java bu soruda minimum casting int-int methodu secerek sonucu yazdırdı
        toplama(5,6,5.3); // 3 double'in toplami : 16.3 - toplama(int a,int b,int c) uymadı cunku double sayı
        // int a otomatik atanmaz.
    }
