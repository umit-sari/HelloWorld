...
public class C02_IfElseIfStatements {
    public static void main(String[] args) {
        ...
        if (girilenSayi%3==0 && girilenSayi%5==0) System.out.println("super sayi"); // en geniş tanımlamayı en üst if e yazıyoruz.
        else if (girilenSayi % 5 == 0) System.out.println("5'in kati"); //tek satırda yazdıgımızdan {} süslü parantez kullanmadık.
