...
public class C05_WrapperClasses {
    public static void main(String[] args) {
         ...
         */
        int sayi2 = 5;
        Integer sayi3 = sayi2; // int primitive data sı non pri data turune Integer ile cevrildi.
        int sayi4 = sayi3;
        ...
        System.out.println(str1 + str2); // 2233 -burda metin gibi yanyana metin olarak döndürüyor.
        System.out.println(Integer.parseInt(str1) + Integer.parseInt(str2)); // 55
        char ch1 = '7';
        System.out.println(Character.isDigit(ch1)); // true- rakam mı? char degeri  rakam olarak verildiğinden true döndü
        System.out.println(Character.isLetter(ch1)); // false- metin mi?
        System.out.println(Character.isWhitespace(ch1)); // false- boşluk mu?
